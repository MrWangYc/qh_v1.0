...
<body style="margin-top: 14px;">
  <form class="layui-form" action="">
    <input type="hidden" name="object.memCate.id" value="${object.id}">
    ...
    <div class="layui-form-item">
      <div class="layui-inline">
        ...
        <div class="layui-input-block">
          ...
          <input type="hidden" id="mId" class="layui-input"  value="${object.membership.id}"/>
        </div>
      </div>
      <div class="layui-inline">
    ...
    <div class="layui-form-item">
      ...
      <div id="date_div" class="layui-inline  ${object.type!='1'?'':'layui-hide'}">
        <label class="layui-form-label">开始时间</label>
        <div class="layui-input-block">
          <input type="text" class="layui-input" readonly="readonly"  style="width: 212px;" value="${object.startDate}" placeholder="yyyy-MM-dd">
        </div>
      </div>
      <div class="layui-inline ${object.type!='1'?'':'layui-hide'}">
        <label class="layui-form-label">截止时间</label>
        <div class="layui-input-block">
          <input type="text" class="layui-input" readonly="readonly"  style="width: 212px;" value="${object.endDate}" placeholder="yyyy-MM-dd">
        </div>
      </div>
      <div id="num_div"  class="layui-inline  ${object.type=='1'?'':'layui-hide'}">
        <label class="layui-form-label">总次数</label>
        <div class="layui-input-block">
          <input type="text" style="width: 212px;" id="cNum" readonly="readonly"  value="${object.totalDegree}" autocomplete="off"  class="layui-input" maxlength="20">
        </div>
      </div>
      <div class="layui-inline ${object.type=='1'?'':'layui-hide'}">
        <label class="layui-form-label">剩余次数</label>
        <div class="layui-input-block">
          <input type="text" style="width: 212px;" readonly="readonly"  value="${object.remainder}" autocomplete="off"  class="layui-input" maxlength="20">
        </div>
      </div>
    </div>
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input type="text" class="layui-input" style="width: 212px;" id="test19" name="object.cDate" placeholder="yyyy-MM-dd">
      </div>
    </div>
    <div class="layui-form-item layui-form-text">
      <label class="layui-form-label">情况说明</label>
      <div class="layui-input-block">
        <textarea placeholder="请输入内容" class="layui-textarea" name="object.remark"></textarea>
      </div>
    </div>
