...
<script>
  layui.use('table', function() {
      ...
      table.render({
          elem: '#LAY_table_user'
          , url: 'employee!list.action?flag=json'
          , cols: [[
              {checkbox: true, fixed: true}
              , {field: 'name', title: '姓名', width: 100}
              , {field: 'company', title: '公司', width: 200}
              , {field: 'position', title: '角色', width: 80}
      ...
      var $ = layui.$, active = {
          ...
          getCheckData: function(){ //获取选中数据
              ...
              closeBtn: 1,
              shadeClose: false,
              content: 'employee!edit.action?flag=edit&object.id='+data[0].id
              });
          },
          delCheckData:function () {
              ...
              layer.confirm('真的删除行么', function(index){
                  layer.close(index);
                  //向服务端发送删除指令
                  startRequest("employee!del.action", function(text){
                      layer.alert(text);
  ...
  function add() {
      layer.open({
          ...
          closeBtn: 1,
          shadeClose: false,
          content: 'employee!edit.action?flag=add'
      });
  }
</script>
