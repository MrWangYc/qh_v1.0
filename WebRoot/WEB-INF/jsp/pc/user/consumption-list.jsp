...
<div>
  <div class="layui-btn-group demoTable">
    <%--<at:popedom cid="20">--%>
      <%--<button class="layui-btn" onclick="add()">电话跟进</button>--%>
    <%--</at:popedom>--%>
    <at:popedom cid="21">
...
<script>
  layui.use('table', function() {
      ...
      table.render({
          elem: '#LAY_table_user'
          , url: 'consumption!list.action?flag=json'
          , cols: [[
              {checkbox: true, fixed: true}
              , {field: 'mName', title: '会员名称', width: 100}
              , {field: 'mPhone', title: '会员号码', width: 200}
              , {field: 'cName', title: '活动名称', width: 180, sort: true}
              , {field: 'cType', title: '活动类别', width: 180, sort: true}
              , {field: 'cDate', title: '消费时间 ', width: 180, sort: true}
          ]]
          , id: 'testReload'
          , page: true
          , height: 707
      ...
      var $ = layui.$, active = {
          ...
          getCheckData: function(){ //获取选中数据
              ...
              closeBtn: 1,
              shadeClose: false,
              content: 'consumption!edit.action?flag=edit&object.id='+data[0].id
              });
          },
          delCheckData:function () {
              ...
              layer.confirm('真的删除行么', function(index){
                  layer.close(index);
                  //向服务端发送删除指令
                  startRequest("consumption!del.action", function(text){
                      layer.alert(text);
  ...
  function add() {
      layer.open({
          ...
          closeBtn: 1,
          shadeClose: false,
          content: 'consumption!edit.action?flag=add'
      });
  }
</script>
