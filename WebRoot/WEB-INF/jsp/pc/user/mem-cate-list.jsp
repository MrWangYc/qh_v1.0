...
<div>
  <div class="layui-btn-group demoTable">
    ...
    <at:popedom cid="25">
      <button class="layui-btn " data-type="use">登记</button>
    </at:popedom>
    <at:popedom cid="16">
...
<script>
  layui.use('table', function() {
      ...
      table.render({
          elem: '#LAY_table_user'
          , url: 'mem-cate!list.action?flag=json'
          , cols: [[
              {checkbox: true, fixed: true}
              , {field: 'mName', title: '会员姓名', width: 100}
              , {field: 'mPhone', title: '会员号码', width: 200}
              , {field: 'cName', title: '活动名称', width: 200}
              , {field: 'cType', title: '活动类别', width: 100, sort: true}
      ...
      var $ = layui.$, active = {
          ...
          getCheckData: function(){ //获取选中数据
              ...
              closeBtn: 1,
              shadeClose: false,
              content: 'mem-cate!edit.action?flag=edit&object.id='+data[0].id
              });
          },
          use: function(){ //获取选中数据
              var checkStatus = table.checkStatus('testReload')
              ...
              layer.open({
                  ...
                  closeBtn: 1,
                  shadeClose: false,
                  content: 'mem-cate!edit.action?flag=use&object.id='+data[0].id
              });
          },
          delCheckData:function () {
              ...
              layer.confirm('真的删除行么', function(index){
                  layer.close(index);
                  //向服务端发送删除指令
                  startRequest("mem-cate!del.action", function(text){
                      layer.alert(text);
  ...
  function add() {
      layer.open({
          ...
          closeBtn: 1,
          shadeClose: false,
          content: 'mem-cate!edit.action?flag=add'
      });
  }
</script>
