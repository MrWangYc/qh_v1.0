...
<script>
  layui.use('table', function() {
      ...
      table.render({
          elem: '#LAY_table_user'
          , url: 'category!list.action?flag=json'
          , cols: [[
              {checkbox: true, fixed: true}
              , {field: 'name', title: '活动名称', width: 100}
              , {field: 'type', title: '活动类别', width: 200}
      ...
      var $ = layui.$, active = {
          ...
          getCheckData: function(){ //获取选中数据
              ...
              closeBtn: 1,
              shadeClose: false,
              content: 'category!edit.action?flag=edit&object.id='+data[0].id
              });
          },
          delCheckData:function () {
              ...
              layer.confirm('真的删除行么', function(index){
                  layer.close(index);
                  //向服务端发送删除指令
                  startRequest("category!del.action", function(text){
                      layer.alert(text);
  ...
  function add() {
      layer.open({
          ...
          closeBtn: 1,
          shadeClose: false,
          content: 'category!edit.action?flag=add'
      });
  }
</script>
