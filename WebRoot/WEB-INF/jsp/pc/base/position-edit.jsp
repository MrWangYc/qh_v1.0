  ...
  <form class="layui-form" action="">
    ...
    <div class="layui-form-item">
      <div class="layui-inline">
        ...
        <div class="layui-input-block">
          <select name="object.dataAuth" >
            <option value=""></option>
            <option value="1" ${object.dataAuth==1?"selected":""}>全部</option>
            <option value="2" ${object.dataAuth==2?"selected":""}>本店</option>
            <option value="3" ${object.dataAuth==3?"selected":""}>本人</option>
          </select>
        </div>
      </div>
    </div>
...
<script>
    ...
    layui.use('form', function(){
        ...
        form.on('submit(formDemo)', function(data){
            startRequest("position!edit.action", opHandler, data.field);
            return false;
        });
    });
